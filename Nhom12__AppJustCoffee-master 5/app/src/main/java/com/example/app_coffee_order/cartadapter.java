    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHoler.btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int slht= home.mangsp.get(i).getSoluongsp();
                int giaht= home.mangsp.get(i).getGiasp();
                home.mangsp.get(i).setSoluongsp(slmoinhat);
                int giamoinhat=(giaht*slmoinhat)/slht;
                home.mangsp.get(i).setGiasp(giamoinhat);
