...
public class Cart extends AppCompatActivity {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if(anyItemUnchecked){
                    if(cbxtotal.isChecked()==false)
                        for (int i = 0; i< home.mangsp.size(); i++){
    ...
    private void Anhxa() {
        ...
        home.mangsp.add(new item("Caffee muoi",20,R.drawable.anh2,1));
        home.mangsp.add(new item("Caffee sua",30,R.drawable.anh3,1));
        home.mangsp.add(new item("Caffee dac biet",24,R.drawable.anh4,1));
        home.mangsp.add(new item("Caffee muoi",20,R.drawable.anh2,1));
        home.mangsp.add(new item("Caffee sua dat",30,R.drawable.anh3,1));
        home.mangsp.add(new item("Caffee dac",24,R.drawable.anh4,1));
        home.mangsp.add(new item("Caffee phim",20,R.drawable.anh2,1));
        home.mangsp.add(new item("Caffee vip",30,R.drawable.anh3,1));
        home.mangsp.add(new item("Caffee dang",24,R.drawable.anh4,1));
    ...
    public static void EvenUtil() {
        ...
        for (int i = 0; i< home.mangsp.size(); i++){
            if(adapter.checkedItems.get(i)){
                tongtien+= home.mangsp.get(i).getGiasp();
            }
        }
    ...
    private void CactchOnIteamListview() {
        imgthungrac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int j = home.mangsp.size() - 1; j >= 0; j--) {
