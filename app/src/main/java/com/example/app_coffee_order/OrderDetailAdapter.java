...
public class OrderDetailAdapter extends RecyclerView.Adapter<OrderDetailAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.productPrice.setText(String.valueOf(orderItem.getProductPrice())); // Chuyển giá trị thành chuỗi
        ...
        holder.productTotal.setText(String.valueOf(totalPrice));
        holder.totalPayment.setText(String.valueOf(totalPrice));
